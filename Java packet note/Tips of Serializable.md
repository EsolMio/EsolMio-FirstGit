...
- 若需要自定义序列化方式，有两种选择：
   ...
   - 创建两个private修饰的`private void writeObject(ObjectOutputStream stream) throws IOException`和`readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException`
